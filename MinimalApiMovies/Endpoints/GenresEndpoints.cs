...
namespace MinimalApiMovies.Endpoints {
    public static class GenresEndpoints {
        ...
        static async Task<Created<GenreDTO>> Create(CreateGenreDTO createGenreDTO, IOutputCacheStore outputCacheStore, IGenresRepository repository, IMapper mapper, IValidator<CreateGenreDTO> validator) {
        ...
        static async Task<Results<NoContent, NotFound>> Update(int id, CreateGenreDTO createGenreDTO, IGenresRepository repository, IOutputCacheStore outputCacheStore, IMapper mapper, IValidator<CreateGenreDTO> validator) {
            var genre = mapper.Map<Genre>(createGenreDTO);
